...
class CreateTelephonePropagandaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('telephone_propagandas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('telephone_propagandas');
    }
}
