...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {{ Form::open(['route' => 'boe_actives.store', 'method' => 'post', 'files' => true]) }}
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-outline-success" onclick="return confirm('確定送出嗎？')"><i class="fas fa-forward"></i> 儲存「教育處自辦活動成果」並下一步填寫照片說明</button>
