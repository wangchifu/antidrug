...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {{ Form::open(['route' => 'other_propagandas.store', 'method' => 'post', 'files' => true]) }}
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-outline-success" onclick="return confirm('確定送出嗎？')"><i class="fas fa-forward"></i> 儲存「毒品危害防治宣導(其他)」並下一步填寫照片說明</button>
