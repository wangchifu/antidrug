            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="header__top__right">
                        <div class="header__top__right__social">
                            <a href="https://newboe.chc.edu.tw" target="_blank"><i class="fas fa-cloud"></i> 教育處新雲端</a>
                            <a href="https://www.chcg.gov.tw" target="_blank"><i class="fas fa-landmark"></i> 彰化縣政府</a>
                            <a href="#"><i class="fas fa-link"></i> 相關網站</a>
                            <a href="#"><i class="fas fa-id-card"></i> 聯絡資訊</a>
                        </div>
                        <div class="header__top__right__auth">
                            <?php
                            $schools = config('antidrug.schools');
