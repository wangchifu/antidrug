...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {{ Form::open(['route' => 'urine_screen_books.store', 'method' => 'post']) }}
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="quantity" id="quantity" required onFocus="if(this.value=='0')this.value='';" onBlur="if(this.value=='')this.value='0';" value="0" onchange="total();">
            </div>
            <div class="form-group">
                <label for="negative">陰性人數<strong class="text-danger">*</strong>
                </label>
                <input type="number" class="form-control" name="negative" id="negative" required onFocus="if(this.value=='0')this.value='';" onBlur="if(this.value=='')this.value='0';" value="0" onchange="total();">
            </div>
            <div class="form-group">
                <label for="positive">陽性人數<strong class="text-danger">*</strong>
                </label>
                <input type="number" class="form-control" name="positive" id="positive" required onFocus="if(this.value=='0')this.value='';" onBlur="if(this.value=='')this.value='0';" value="0" onchange="total();">
            </div>
            <div class="form-group">
                <label for="remain">結餘<strong class="text-danger">*</strong>
                </label>
                <input type="number" class="form-control" name="remain" id="remain" required onFocus="if(this.value=='0')this.value='';" onBlur="if(this.value=='')this.value='0';" value="0" readonly>
            </div>
            <div class="form-group">
