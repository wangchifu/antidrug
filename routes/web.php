...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('upload1/tzuchi_propaganda', [TzuchiPropagandaController::class, 'index'])->name('tzuchi_propagandas.index');
    Route::get('upload1/tzuchi_propaganda/create', [TzuchiPropagandaController::class, 'create'])->name('tzuchi_propagandas.create');
    Route::get('upload1/tzuchi_propaganda/{tzuchi_propaganda}/edit', [TzuchiPropagandaController::class, 'edit'])->name('tzuchi_propagandas.edit');
    Route::post('upload1/tzuchi_propaganda/store', [TzuchiPropagandaController::class, 'store'])->name('tzuchi_propagandas.store');
    Route::post('upload1/tzuchi_propaganda/{tzuchi_propaganda}/update', [TzuchiPropagandaController::class, 'update'])->name('tzuchi_propagandas.update');
    Route::get('upload1/tzuchi_propaganda/{tzuchi_propaganda}/del_pic', [TzuchiPropagandaController::class, 'del_pic'])->name('tzuchi_propagandas.del_pic');
    Route::get('upload1/tzuchi_propaganda/{tzuchi_propaganda}/destroy', [TzuchiPropagandaController::class, 'destroy'])->name('tzuchi_propagandas.destroy');
...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::get('review1/tzuchi_propaganda/review/{date1?}/{date2?}', [TzuchiPropagandaController::class, 'review'])->name('tzuchi_propagandas.review');
    Route::post('review1/tzuchi_propaganda/search', [TzuchiPropagandaController::class, 'search'])->name('tzuchi_propagandas.search');
    Route::get('review1/tzuchi_propaganda/statistics/{date1}/{date2}', [TzuchiPropagandaController::class, 'statistics'])->name('tzuchi_propagandas.statistics');
